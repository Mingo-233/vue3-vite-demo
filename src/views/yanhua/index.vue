<template>
  <div style="height: 100%; overflow: hidden">
    <canvas id="cas" style="background-color: rgba(0, 5, 24, 0.8)"
      >浏览器不支持canvas</canvas
    >
  </div>
  <div class="hecheng">
...
onMounted(() => {
  ...
  var lastTime;
  let txtTimerlastTime = 0;
  let countDownNumber = 11999;
  function animate() {
    ctx.save();
  ...
  function countDown(ctx) {
    ...
    if (newTime - txtTimerlastTime > 1000) {
      txtTimerlastTime = newTime;
      countDownNumber--;
    }
    ctx.fillStyle = "#010317";
    ctx.fillRect(1000, 50, 100, 100);
    //   ctx.clearRect(1000, 50, 100, 100);
    if (countDownNumber < 0) {
      canvas.style.display = "none";
      txtTimerlastTime = 99999999999;
      closeFlag = true;
      return;
    }
    ctx.font = "48px serif";
    ctx.fillStyle = "rgba(255,255,255,1)";
    ctx.fillText(countDownNumber, 1000, 100);
