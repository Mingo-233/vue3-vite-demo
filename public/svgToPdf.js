var SVGtoPDF = function (doc, svg, x, y, options) {
  ...
  function createSVGElement(obj, inherits) {
    console.log("createSVGElement", obj, obj.nodeName);
  ...
  var SvgElemSvg = function (obj, inherits) {
    ...
    console.log("SvgElemContainer", width);
